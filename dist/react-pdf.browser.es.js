...
var getFragments = function getFragments(instance) {
  ...
  for (var _i = 0, _PREPROCESSORS = PREPROCESSORS; _i < _PREPROCESSORS.length; _i++) {
    var preprocessor = _PREPROCESSORS[_i];
      ...
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              this.root.instance.save();
              layout = this.getAbsoluteLayout();
              SVGtoPDF(this.root.instance, this.props.content, layout.left, layout.top, this.props.svgToPdfOptions);
              if (this.props.debug) this.debug();
              this.root.instance.restore();
...
export default dom;
export { BlobProvider, Canvas$1 as Canvas, Document$2 as Document, Font$1 as Font, Image$1 as Image, Link$1 as Link, Note$1 as Note, PDFDownloadLink, PDFRenderer, PDFViewer, Page$1 as Page, StyleSheet, Svg$1 as Svg, Text$1 as Text, View$1 as View, createInstance, pdf, version };
